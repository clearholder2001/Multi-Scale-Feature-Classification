...
namespace StringUtilities
{
	...
	//General purpose convertor class for System::std::string (both from and to)
	ref class StringConvertor : StringConvertorBase
	{
	protected:
		String^ m_String; //The internal System::std::string object
	...
	public:
		...
		//Returns an interior pointer to the underlying std::string that can be
